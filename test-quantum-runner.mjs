/**
 * Quick Quantum Test - Run with: node test-quantum-runner.mjs
 */
import { qppuEngine } from './src/engine/QPPUCore.js';
...
console.log('');
console.log('%c✓ All quantum operations executed!', 'color: #10b981; font-weight: bold');